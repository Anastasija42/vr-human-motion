...
{
    // Declare an instance of a panda robot. Created at runtime in Start(), so
    // it must not be serialized (PandaRobot is a plain C# class).
    [NonSerialized] public PandaRobot PD;
